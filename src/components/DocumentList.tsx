  ...
  return (
    <div className="space-y-3 animate-fade-in">
      {documents.map((doc) => (
        ...
        >
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center w-full gap-2">
            ...
            <div className="hidden sm:block mx-2 text-avant-medium-gray">•</div>
            <div className="font-medium group-hover:underline break-words whitespace-normal">
              {doc.title}
            </div>
            <div className="text-sm text-avant-medium-gray break-words whitespace-normal ml-2">
